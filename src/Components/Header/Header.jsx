  ...
  return (
    <div>
        <header>
            ...
            <a className="heroBtn" href='https://docs.google.com/forms/d/e/1FAIpQLScWCYu5tbKWFDge73PTSXRePVGngxlqfjWZ69Cf1Om-M5JKEg/viewform?usp=header' target='_blank'>Start Learning Now</a>
        </header>
    </div>
  )
}