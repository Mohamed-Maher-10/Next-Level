  ...
  return (
    <div id='home'>
      ...
      <div id='courses'>
        ...
        <CourseCard logo={kids} title="Junior Coders Program" desc="Empower your child with essential coding skills. From logic building with Scratch and core programming concepts in C++, to real-world software creation in Python—all through fun, hands-on projects." />
      </div>
